...
Reviewed artifact: `docs/plans/units/u1-corrective-architecture-package-contract.md`
...
style guide, program plan, child registry, durable issue, current implementation and tests, and the
