...
| U1A | [Documentation discoverability and continuous authoring quality gates](./u1a-documentation-authoring-quality-gates.md) | Corrected U1 | planned; refreshed clean-room review required |
